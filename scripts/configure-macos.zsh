...
configure_screen_settings() {
    ...
    set_default "com.apple.screencapture" "location" "$HOME/Desktop"
...
configure_finder() {
    ...
    set_default "com.apple.finder" "NewWindowTargetPath" "file://$HOME/Desktop/"
    
    # Show icons for hard drives, servers, and removable media on the desktop
    set_default "com.apple.finder" "ShowExternalHardDrivesOnDesktop" "true" "bool"
    set_default "com.apple.finder" "ShowHardDrivesOnDesktop" "true" "bool"
    set_default "com.apple.finder" "ShowMountedServersOnDesktop" "true" "bool"
