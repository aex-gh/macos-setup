...
@test "main setup script exists and is executable" {
    assert_file_exists "${BATS_TEST_DIRNAME}/../scripts/setup.zsh"
    [[ -x "${BATS_TEST_DIRNAME}/../scripts/setup.zsh" ]]
}
...
@test "setup script creates necessary directories" {
    run "${BATS_TEST_DIRNAME}/../scripts/setup.zsh" --dry-run --verbose
...
@test "setup script accepts command line arguments" {
    run "${BATS_TEST_DIRNAME}/../scripts/setup.zsh" --help
...
@test "setup script shows version information" {
    run "${BATS_TEST_DIRNAME}/../scripts/setup.zsh" --version
